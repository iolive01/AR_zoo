...
var clues = ['app/resources/Uploaded/snake_clue_0.png', 'app/resources/Uploaded/snake_answer_0.png', 'app/resources/Uploaded/snake_clue_1.png', 'app/resources/Uploaded/snake_answer_1.png', 'app/resources/Uploaded/snake_clue_2.png', 'app/resources/Uploaded/snake_answer_2.png'];
var tapObjs = ['tapObj0','tapObj1','tapObj2'];
var tapObjIndex=-1;
var startImage = 'app/resources/Uploaded/snake_start.png';
var endImage = 'app/resources/Uploaded/snake_end.png';
...
var hintText = ['Hint: Try tapping near the mouth!', 'Hint: Try tapping near the eyes!', 'Hint: Try tapping near the upper middle of the snake!'];
...
$scope.rotateModel = function(){
  ...
  myAudio = new Audio('app/resources/Uploaded/rainforest_sounds__waterfall_and_rain.mp3'); 
...
$scope.TestIncorrectTap = function() {
	if($scope.app.view.Snake.wdg[startButton]['visible'] == false && $scope.app.view.Snake.wdg[restartButton]['visible'] == false&& $scope.app.view.Snake.wdg[nextButton]['visible'] == false) {
numberOfIncorrect++;
...
function ChangeProperty(object, property, value) {
	...
	$scope.app.view.Snake.wdg[object][property] = value;
  	//$scope.app.view.Snake.wdg[object].UpdatePropertyValues($scope.app.view.Snake.wdg[object][property]);
