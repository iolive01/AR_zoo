...
var clues = ['app/resources/Uploaded/elephant_clue_0.png', 'app/resources/Uploaded/elephant_answer_0.png', 'app/resources/Uploaded/elephant_clue_1.png', 'app/resources/Uploaded/elephant_answer_1.png', 'app/resources/Uploaded/elephant_clue_2.png', 'app/resources/Uploaded/elephant_answer_2.png'];
var tapObjs = ['tapObj0','tapObj1','tapObj2'];
var tapObjIndex=-1;
var startImage = 'app/resources/Uploaded/elephant_start.png';
var endImage = 'app/resources/Uploaded/elephant_end.png';
...
var hintText = ['Hint: Try tapping near the mouth!', 'Hint: Try tapping near the backside of the elephant!', 'Hint: Try tapping near the head!'];
...
$scope.rotateModel = function(){
  ...
  myAudio = new Audio('app/resources/Uploaded/Savannah_Ambiance.mp3'); 
...
$scope.TestIncorrectTap = function() {
	if($scope.app.view.elephant_2.wdg[startButton]['visible'] == false && $scope.app.view.elephant_2.wdg[restartButton]['visible'] == false&& $scope.app.view.elephant_2.wdg[nextButton]['visible'] == false) {
numberOfIncorrect++;
...
ChangeProperty('shark_badge', 'text', '🦈');
        if(myStorage.getItem('completedSnake')=='yes'&&myStorage.getItem('completedelElephant')=='yes'&&myStorage.getItem('completedShark')=='yes') {
            ChangeProperty('snake_badge', 'opacity', .2); 
			      ChangeProperty('shark_badge', 'opacity', .2);
            ChangeProperty('elephant_badge', 'opacity', .2); }
  }
  scanned = true;
}
...
if(exhibitNumber==1) {
      ...
      $scope.app.params.exhibit_2_complete= 0;
        ...
        myStorage.setItem('completedelShark', 'yes');
...
function ChangeProperty(object, property, value) {
	...
	$scope.app.view.elephant_2.wdg[object][property] = value;
  	//$scope.app.view.elephant_2.wdg[object].UpdatePropertyValues($scope.app.view.elephant_2.wdg[object][property]);
